<?php
	...
	if(isset($theme_settings['settings']['xp_theme'])){
		$col_theme = $theme_settings['settings']['xp_theme'];			// Couleur du thème (sombre ou clair)
	}else{
		$col_theme = 'theme_blue';
	}
